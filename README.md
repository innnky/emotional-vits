...
+ 对于只有一个角色的模型，可以通过预先筛选的方式，及手动挑选几条“激动”、“平静”、“小声”之类的音频，手动实现情感文本->情感embedding的对应关系
+ 对于有多个角色的模型，上述预筛选的方式有局限性，因为例如同样对于“平静”这一个情感而言，不同角色对应的情感embedding可能会不同，导致建立情感文本->情感embedding的映射关系很繁琐
