...
def run(rank, n_gpus, hps):
    ...
    train_dataset = TextAudioSpeakerLoader(hps.data.training_files, hps.data, hps.emotionType)
    ...
    if rank == 0:
        eval_dataset = TextAudioSpeakerLoader(hps.data.validation_files, hps.data, hps.emotionType)
